...
export default function WanTab({ fullDevice, onOpenWanConfig }) {
  return (
    <div className="space-y-4 animate-in fade-in slide-in-from-right-2 duration-300">
      <div className="bg-surface-dark/50 p-4 sm:p-6 rounded-xl border border-slate-border">
        <h4 className="text-xs font-bold text-fg-muted uppercase tracking-widest mb-4">WAN Interface Details</h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-1">
          <div className="flex flex-wrap items-center justify-between gap-2 py-2 border-b border-slate-border min-w-0">
      ...
      <div
        className="bg-slate-950/50 p-4 rounded-xl border border-slate-900 flex items-center justify-between group cursor-pointer hover:bg-surface-dark transition-colors"
