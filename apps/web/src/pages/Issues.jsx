            ...
            <div className="p-4 border-b border-slate-border flex flex-col gap-4">
                <div className="flex items-center justify-between gap-2">
                    <div className="min-w-0">
                        ...
                        <p className="text-fg-muted text-xs md:sm">Monitor system performance</p>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-auto p-6">
                {filteredAlerts.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed border-slate-border rounded-xl">
                        ...
                        <h3 className="text-lg font-medium text-fg mb-1">{searchQuery ? 'No matching issues' : 'No active issues'}</h3>
                        <p className="text-fg-muted">{searchQuery ? 'Try a different search term' : 'System performance is optimal'}</p>
                    </div>
                ) : (
                                    ...
                                    <div className="flex items-start justify-between gap-2 sm:gap-4">
                                        <div className="flex items-start gap-2 sm:gap-3 min-w-0 flex-1">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                ...
                                                <p className="text-xs sm:text-sm text-fg-muted mt-0.5 sm:mt-1 line-clamp-2 sm:line-clamp-none">{alert.message}</p>
