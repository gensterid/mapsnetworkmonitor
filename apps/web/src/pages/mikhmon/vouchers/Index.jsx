...
export default function VouchersPage() {
    ...
    // Comment buckets — group by note tag (vc-NNN-mm.dd.yy-...) so the
    // operator can quickly drill into one generate batch. Mirrors MikHMON
    // external "Filter by Comment" dropdown.
