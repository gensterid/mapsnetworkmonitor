            ...
            <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-xs text-slate-500">Group IP untuk firewall (isolir, whitelist, blacklist).</p>
                    </div>
                </div>
                    ...
                    <table className="w-full text-sm min-w-[700px]">
                        ...
                        <tbody className="divide-y divide-slate-800/40">
                            {isPending ? (
                                ...
                                <tr key={a.id} className={clsx('hover:bg-slate-800/30 transition-colors', a.disabled && 'opacity-50', a.dynamic && 'italic')}>
                                    ...
                                    <td className="px-4 py-2.5 font-mono text-xs text-slate-400">{a.timeout || <span className="text-slate-600">∞</span>}</td>
                                    <td className="px-4 py-2.5 text-xs text-slate-300 max-w-xs truncate">{a.comment || ''}</td>
                                    <td className="px-4 py-2.5">
                                        <span className={clsx(
