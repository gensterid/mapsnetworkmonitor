                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <Field label="On Event *" hint="RouterOS script" span={2}>
                        <textarea
                            ...
                            className="bg-surface-dark/60 border border-slate-border/60 text-slate-200 text-xs font-mono rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-primary/40"
                            required
                        />
                    </Field>
                    ...
                    <table className="w-full text-sm min-w-[700px]">
                        ...
                        <tbody className="divide-y divide-slate-800/40">
                            {isPending ? (
                                ...
                                <tr key={s.id} className={clsx('hover:bg-slate-surface/30 transition-colors', s.disabled && 'opacity-50')}>
