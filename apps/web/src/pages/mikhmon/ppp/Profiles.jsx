            ...
            <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-xs text-slate-500">Paket PPPoE (rate-limit, address pool, parent-queue).</p>
                    </div>
                </div>
                                ...
                                <tr key={p.id} className="hover:bg-slate-800/30 transition-colors">
                                    ...
                                    <td className="px-4 py-2.5 font-mono text-xs text-slate-400">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-slate-500">{p.remoteAddress || ''}</span>
                                        </div>
                                    </td>
                                    <td className="px-4 py-2.5 font-mono text-xs text-slate-400">{p.onlyOne || 'default'}</td>
