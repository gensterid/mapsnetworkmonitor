...
const SECTIONS = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: 'hotspot/walled-garden', label: 'Walled Garden', icon: ShieldCheck, ready: false },
            { path: 'hotspot/cookies', label: 'Cookies', icon: FileBox, ready: false },
    ...
    },
    {
        group: 'IP / Queue',
        items: [
            { path: 'queues', label: 'Simple Queue', icon: Gauge, ready: false },
