            ...
            <div className="flex items-start sm:items-center justify-between gap-3 flex-wrap">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-xs text-fg-muted">Profile server hotspot (captive portal config, login methods).</p>
                    </div>
                </div>
                                ...
                                <tr key={p.id} className="hover:bg-slate-800/30 transition-colors">
                                    ...
                                    <td className="px-4 py-2.5 font-mono text-xs text-fg">
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-fg-muted">{p.hotspotAddress || ''}</span>
                                        </div>
                                    </td>
                                    <td className="px-4 py-2.5 font-mono text-xs text-fg-muted">{p.htmlDirectory || <span className="text-slate-600">—</span>}</td>
                                    <td className="px-4 py-2.5 font-mono text-xs text-fg-muted max-w-[200px] truncate">{p.loginBy || <span className="text-slate-600">—</span>}</td>
