                ...
                <table className="w-full text-left border-collapse">
                    <thead className="sticky top-0 z-10 text-slate-400 text-[10px] uppercase font-bold tracking-wider">
                        <tr>
                            ...
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">Name</th>
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">IP Address</th>
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">Hardware</th>
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">CPU</th>
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">Memory</th>
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">Uptime</th>
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">Speed</th>
                            <th className="px-4 py-3 bg-slate-800/98 backdrop-blur-sm">Latency</th>
                            <th className="px-4 py-3 text-right bg-slate-800/98 backdrop-blur-sm">Last Sync</th>
