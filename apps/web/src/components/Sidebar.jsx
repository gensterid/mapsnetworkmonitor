...
const SETTINGS_GROUPS = [
    ...
    },
    {
        ...
        items: [
            ...
            { path: '/provisioning/authorize', icon: Zap, label: 'Authorize ONU', roles: ['admin', 'operator'], feature: 'olt' },
            { path: '/provisioning/modify', icon: Wrench, label: 'Modify ONT', roles: ['admin', 'operator'], feature: 'olt' },
