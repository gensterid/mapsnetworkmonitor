                    ...
                    <table className="w-full text-sm">
                        <thead>
                            <tr className="border-b border-slate-800 bg-slate-800/50">
                                ...
                                <th className="text-left py-3 px-4 text-xs font-medium text-slate-400 uppercase">Address</th>
                                <th className="text-left py-3 px-4 text-xs font-medium text-slate-400 uppercase">Uptime</th>
                                <th className="text-left py-3 px-4 text-xs font-medium text-slate-400 uppercase">Caller ID</th>
                                <th className="text-left py-3 px-4 text-xs font-medium text-slate-400 uppercase">Coordinates</th>
                                <th className="text-right py-3 px-4 text-xs font-medium text-slate-400 uppercase">Action</th>
                            </tr>
                        </thead>
