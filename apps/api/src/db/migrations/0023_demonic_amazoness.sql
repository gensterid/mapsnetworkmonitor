...
ALTER TABLE "users" ADD COLUMN "ai_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "ai_api_key" text;--> statement-breakpoint
ALTER TABLE "router_groups" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
ALTER TABLE "router_metrics" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
ALTER TABLE "router_netwatch" ADD COLUMN "topology_x" numeric(10, 2);--> statement-breakpoint
ALTER TABLE "router_netwatch" ADD COLUMN "topology_y" numeric(10, 2);--> statement-breakpoint
ALTER TABLE "router_netwatch" ADD COLUMN "has_webhook" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "router_netwatch" ADD COLUMN "is_app_only" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "router_netwatch" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "gateway_id" uuid;--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "romon_mac" text;--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "parent_interface" text;--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "last_neighbors_sync" timestamp;--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "topology_x" numeric(10, 2);--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "topology_y" numeric(10, 2);--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "last_full_sync" timestamp;--> statement-breakpoint
ALTER TABLE "routers" ADD COLUMN "last_error_message" text;--> statement-breakpoint
ALTER TABLE "alerts" ADD COLUMN "tenant_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "alerts" ADD COLUMN "ai_analysis" text;--> statement-breakpoint
ALTER TABLE "netwatch_hosts" ADD COLUMN "tenant_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "app_settings" ADD COLUMN "tenant_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "audit_logs" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
ALTER TABLE "notification_groups" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
ALTER TABLE "pppoe_sessions" ADD COLUMN "tenant_id" uuid NOT NULL;--> statement-breakpoint
ALTER TABLE "olts" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
ALTER TABLE "olts" ADD COLUMN "topology_x" numeric(10, 2);--> statement-breakpoint
ALTER TABLE "olts" ADD COLUMN "topology_y" numeric(10, 2);--> statement-breakpoint
ALTER TABLE "onus" ADD COLUMN "tenant_id" uuid;--> statement-breakpoint
