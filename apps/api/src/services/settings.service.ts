...
export class SettingsService {
    ...
    async seedDefaults(tenantId: string): Promise<void> {
        const defaults = [
            ...
            { key: 'acs_sync_enabled', value: false, description: 'Enable GenieACS Sync' },
            { key: 'genieacs_enabled', value: false, description: 'GenieACS Master Switch — enable per-tenant' },
            { key: 'genieacs_global_enabled', value: false, description: 'Use Global GenieACS Server as fallback' },
